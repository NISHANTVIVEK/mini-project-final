...
* The application bean has the fields for the application form as
...
public class Application {
	...
	public Application(int app_id, String full_name, String dob, String highest_qualification, double marks, String goals,
